  ...
  return (
    <main className="flex flex-col min-h-[80vh] pb-10 bg-gray-100 px-20">
      ...
      <textarea
        ...
        value={inputText}
        onChange={(e) =>
          lang == "english" ? handleOnChange(e) : handleHindiInput(e)
        }
        onKeyDown={(e) =>
          lang == "english" ? handleOnKeyDown(e) : keyDownHindiHandle(e)
        }
      />
      <button
        className=" mt-4 border-2 border-gray-400 text-gray-400 font-bold hover:border-black hover:text-black hover:bg-white py-3 px-5 rounded-md"
        onClick={
          lang == "english" ? handleTestComplete : handleHindiTestComplete
        }
      >
        Submit
      </button>
